...
const ProductsPage = () => {
    ...
    const [editProduct, setEditProduct] = useState(null); // ✅ to track editing
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Search & Filters */}
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "3%", gap: "2%" }}>
                    <input
                        type="text"
                            ...
                            {filteredProducts.map((p) => {
                                ...
                                return (
                                    <tr key={p.id} style={{ borderBottom: "1px solid #f3f4f6" }}>
                                        ...
                                        <td style={{ padding: "1.5vh" }}>
                                            <button
                                                onClick={() => setEditProduct(p)} // ✅ edit mode
                                                style={{
                ...
                {(showAddProduct || editProduct) && (
                    <AddProductForm
                        ...
                        editData={editProduct} // pass data if editing
                    />
                )}
            </div>
        </div>
